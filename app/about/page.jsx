...
<div 
  className="relative bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl p-8 sm:p-10 shadow-lg
             ...
             cursor-pointer"
>
  {/* Optional subtle decorative circle (kept for visual interest) */}
      ...
      <div className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              href="/diagnose"
              className="bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium py-3 px-8 rounded-xl transition duration-200"
            >
              Explore Services
            </a>
          </div>
